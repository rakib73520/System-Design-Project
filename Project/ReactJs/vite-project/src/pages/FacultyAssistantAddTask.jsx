...
import style from "./../assets/css/FacultyAssistantAddTask.module.css";
...
const FacultyAssistantAddTask = () => {
  ...
  useEffect(() => {
    ...
    const createTask = async () => {
      ...
      try {
        await axios.post(`${domain}/api/createtask/`, taskdata, {
          headers: {
...
export default FacultyAssistantAddTask;
