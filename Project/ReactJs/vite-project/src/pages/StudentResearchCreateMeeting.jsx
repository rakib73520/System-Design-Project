...
import ResearchCreateMeeting from "../components/ResearchCreateMeeting";
...
const StudentResearchCreateMeeting = () => {
  ...
  return (
    <div>
      ...
      />
      <HeaderResearch />
      <ResearchCreateMeeting />
      <Footer />
    </div>
  );
};

export default StudentResearchCreateMeeting;
