...
import ResearchTaskManagement from "../components/ResearchTaskManagement";
...
const StudentResearchTaskManagement = () => {
  ...
  return (
    <div>
      ...
      />
      <HeaderResearch />
      <ResearchTaskManagement />
      <Footer />
    </div>
  );
};

export default StudentResearchTaskManagement;
