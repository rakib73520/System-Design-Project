...
import ResearchMeetingInformation from "../components/ResearchMeetingInformation";
...
const StudentResearchMeetingInformation = () => {
  ...
  return (
    <div>
      ...
      />
      <HeaderResearch />
      <ResearchMeetingInformation />
      <Footer />
    </div>
  );
};

export default StudentResearchMeetingInformation;
