...
const FacultyAlumniMyInteraction = () => {
    ...
    const getInteraction = async () => {
      try {
        const response = await axios.get(
          `${domain}/api/interaction/${facultydata.id}/${type}/`
        );
  ...
  useEffect(() => {
    const getMessege = async () => {
      try {
        const response = await axios.get(
          `${domain}/api/messeges/${facultydata.id}/${aluid}/${type}/`
        );
  ...
  const handleSend = async () => {
    ...
    if (messege != "") {
      ...
      data.append("sender", facultydata.id);
...
export default FacultyAlumniMyInteraction;
